...
export const HomePage = (props) => {
    ...
    return (
        <div className=' w-full  flex md:flex-row flex-col '>
            ...
            <Icon onclick={() => setSalePopupTrigger(true)} type={saleIcon.type} color={saleIcon.color} className=' absolute md:bottom-15  md:right-20 md:h-20 md:w-20 bottom-10 right-5 h-16 w-16  rounded-full hover:bg-blue-600 ' ></Icon>
        </div>
    )
}
